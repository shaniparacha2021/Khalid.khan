...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Strategic HR and Operations Leader with over 22 years of progressive experience driving Organizational Excellence and AI-Driven HR Transformation.",
    type: "website",
    locale: "en_US",
    images: [
      {
